  ...
  Widget build(BuildContext context) {
    return const Column(
      children: [
        ...
        Row(
          children: [
            Expanded(child: CustomButton(color:Colors.white ,title:"Add more details" ,textColor: Color(0xFF4EB7F2),)),
            SizedBox(width: 24,),
            Expanded(child: CustomButton(title:"Send Money" ,color:Color(0xFF4EB7F2) ,)),
          ],
        )
      ],
    );
